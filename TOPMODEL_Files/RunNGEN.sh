...
# valgrind --leak-check=yes -s ./ngen spatial/catchment_data.geojson cat-12 ./spatial/nexus_data.geojson cat-12 Realizations/Realization_pet_Topmodel_calibNC_short.json > valgrind_log.txt 2>&1
...
# valgrind --leak-check=yes -s ./ngen spatial/catchment_data.geojson cat-12 ./spatial/nexus_data.geojson cat-12 Realizations/Realization_Topmodel_calibNC.json > valgrind_log.txt 2>&1



# CSV
#./ngen spatial/catchment_data.geojson cat-12 ./spatial/nexus_data.geojson cat-12 Realizations/Realization_pet_Topmodel_calibNC_csv.json
# ./ngen spatial/catchment_data.geojson cat-12 ./spatial/nexus_data.geojson cat-12 Realizations/Realization_Topmodel_calibNC_csv.json
# ./ngen ./data/catchment_data.geojson cat-27 ./data/nexus_data.geojson cat-27 Realizations/Realization_pet_Topmodel_calibNC_csv_testing.json
