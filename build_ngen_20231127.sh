...

{
	...
	git clone https://github.com/Ben-Choat/ngen_Calib_CFE_TOPMODEL $folder_name_ngen &&
		cd $folder_name_ngen &&
...
# 	echo -e "Set assuming PWD = ${PWD}\n\n"
	...
	echo -e "\ncompile t-route\n"
        ...
        ######################## end work from 2023/11/14



	# Bchoat, modifying to work with t-route branch/tag (6f8033b)
	# edit ngen/extern/troute/src/pythonframework_v02/troute/HYFeaturesNetwork.py as:
	
	
	# Comment out line 190: self._dataframe['toID'] = self._dataframe['toID'].apply(node_key_func_nexus)
